...
class FlutterQuillLocalizationsKu extends FlutterQuillLocalizations {
  ...
  @override
  String get pleaseEnterTextForYourLink => 'تکایە دەقێک بۆ بەستەرەکەت دابنێ (بۆ نموونە، \'زیاتر بزانە\')';

  @override
  String get pleaseEnterTheLinkURL => 'تکایە لینکێک بۆ بەستەرەکە دابنێ (بۆ نموونە، \'https://example.com\')';
