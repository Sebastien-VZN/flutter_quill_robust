...
class FlutterQuillLocalizationsEl extends FlutterQuillLocalizations {
  ...
  @override
  String get pleaseEnterTextForYourLink => 'Εισαγάγετε κείμενο για τον σύνδεσμό σας (π.χ., \'Μάθετε περισσότερα\')';

  @override
  String get pleaseEnterTheLinkURL => 'Εισαγάγετε το URL του συνδέσμου (π.χ., \'https://example.com\')';
  ...
  @override
  String get caseSensitivityAndWholeWordSearch => 'Διαχωρισμός πεζών-κεφαλαίων και αναζήτηση ολόκληρης λέξης';
