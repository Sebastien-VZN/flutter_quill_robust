...
class FlutterQuillLocalizationsUr extends FlutterQuillLocalizations {
  ...
  @override
  String get pleaseEnterTextForYourLink => 'براہ کرم اپنے لنک کے لیے متن درج کریں (مثال کے طور پر، \'مزید جانیں\')';

  @override
  String get pleaseEnterTheLinkURL => 'براہ کرم لنک کا URL درج کریں (مثال کے طور پر، \'https://example.com\')';
