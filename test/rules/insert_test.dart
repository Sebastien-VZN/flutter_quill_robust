  ...
  group('PreserveInlineStylesRule', () {
    ...
    test('Insert in text', () {
      ...
      expect(
        ...
        Delta()
          ..retain(6)
          ..insert('X', attributes: <String, dynamic>{'bold': true}),
      );
      expect(
    ...
    test('Insert on first line of document with bold text', () {
      ...
      expect(
        ...
        Delta()..insert('X', attributes: <String, dynamic>{'bold': true}),
    ...
    test('Insert around multiple images', () {
      ...
      expect(
        ...
        Delta()
          ..retain(1)
          ..insert('X', attributes: <String, dynamic>{'italic': true}),
      );
      expect(
        rule.apply(document, 2, data: 'X', len: 0),
        Delta()
          ..retain(2)
          ..insert('X', attributes: <String, dynamic>{'underline': true}),
      );
    });
    ...
    test('Insert around images with NL', () {
      ...
      expect(
        ...
        Delta()
          ..retain(2)
          ..insert('X', attributes: <String, dynamic>{'strike': true}),
      );
      expect(
        rule.apply(document, 6, data: 'X', len: 0),
        Delta()
    ...
    test('Insert around non-inline styles', () {
      final delta = Delta()
        ...
        ..insert('first')
        ..insert('\n', attributes: <String, dynamic>{'list': 'ordered'})
        ..insert('A', attributes: <String, dynamic>{'bold': true})
        ..insert('B')
        ..insert('C', attributes: <String, dynamic>{'italic': true})
        ..insert('\n\n', attributes: <String, dynamic>{'list': 'ordered'})
        ..insert('D', attributes: <String, dynamic>{'strike': true})
        ..insert('\n', attributes: <String, dynamic>{'list': 'ordered'})
        ..insert(
          <String, String>{'image': 'url'},
          attributes: <String, dynamic>{'bold': true},
    ...
    test('Insert around link, insert within link label', () {
      final delta = Delta()
        ...
        ..insert('data\n')
        ..insert('link', attributes: <String, dynamic>{'link': 'linkURL', 'bold': true})
        ..insert('\n');
      ...
      expect(
        ...
        Delta()
          ..retain(7)
          ..insert('X', attributes: <String, dynamic>{'link': 'linkURL', 'bold': true}),
    ...
    test('Insert link in text', () {
      ...
      for (final link in validLinks) {
        expect(
          ...
          Delta()..insert(link, attributes: {'link': link}),
        );
      }
    });
